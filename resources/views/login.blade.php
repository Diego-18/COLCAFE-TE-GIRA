...
<div class="modal fade" id="alert_error_registro" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<div class="modal fade" id="modal_error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="background-color: #e32842; border: 0">
            ...
            <center>
                <img src="{{ asset('img/144ppi/alert_error.png') }}" style="position: absolute; margin-left: -39%; margin-top: -31%; width: 80%;">
                <div class="text-center" style="margin-top: 5.5rem;">
                    <h5 class="modal-title" style="font-family: Letra1 !important; font-size:30px">Verifica que los campos estén diligenciados correctamente</h5>
                    <br>
                </div>
            </center>
        </div>
